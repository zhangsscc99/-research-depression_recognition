...
#training_folder
#print(training_folder[0])
#print(testing_folder[0][:-4])
#for i in range(len(training_folder)):
   # if training_folder[i]==testing_folder[i][:-4]:
        #print('right')
#
...
# %%
model.save('/scratch/yw4554/im_de_url/implementation_depression/model_gpu_server/model_big')

# %% [markdown]
# # loading the model

# %%
model2 = keras.models.load_model('/scratch/yw4554/im_de_url/implementation_depression/model_gpu_server/model_big')
...
# %%
import numpy as np
lst=np.ndarray.tolist(features[0])
...
with open("feature_ResNet50_server.csv",'w') as f:
...
# %%
#scp /users/mac/desktop/cropped_aligned.zip yw4554@greene.hpc.nyu.edu:/scratch/yw4554/im_de
#scp /users/mac/desktop/20-50.zip yw4554@greene.hpc.nyu.edu:/scratch/yw4554/im_de/implementation_depression
#scp /users/mac/desktop/implementation_depression/depression_modelsave/resnet50_test.py yw4554@greene.hpc.nyu.edu:/scratch/yw4554/im_de_url/implementation_depression
#scp /users/mac/desktop/implementation_depression/depression_modelsave/resnet50_test.py yw4554@hpc.shanghai.nyu.edu:/scratch/yw4554/im_de_url/implementation_depression
#scp /users/mac/desktop/implementation_depression/depression_modelsave/resnet50_test.py yw4554@hpc.shanghai.nyu.edu:/scratch/yw4554/im_de_url/implementation_depression
#scp /Users/mac/Desktop/implementation_depression/depression_modelsave/resnet50_server.py yw4554@greene.hpc.nyu.edu:/scratch/yw4554/im_de_url/implementation_depression
#scp -r yw4554@hpc.shanghai.nyu.edu:/scratch/yw4554/im_de_url/implementation_depression/model_big /Users/mac/Desktop/implementation_depression/model_gpu
#scp /Users/mac/Desktop/implementation_depression/depression_modelsave/resnet50_server.py yw4554@hpc.shanghai.nyu.edu:/scratch/yw4554/im_de_url/implementation_depression
